...
<section class="hero">
    <div class="hero-showcase text-center bold">
        ...
        <img class="book-cover" src={bookCover}/>
        <img class="phone-cover" src={phoneCover}/>
    </div>
    <div class="hero-text white text-center">
        ...
        {:else}
            ...
            <p class="light-grey mb-m">
                I moved to Spain seven years ago. The process was painful and difficult. I learned most things the hard
                way: finding a job, getting a visa, calculating my cost of living, choosing an apartment. That is why I
